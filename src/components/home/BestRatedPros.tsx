...
import { TOP_PROFESSIONALS, ProProfile, ServiceItem, getMatchingServiceForPro } from "@/lib/homeData";

interface BestRatedProsProps {
  onOpenBooking: (service?: ServiceItem, pro?: ProProfile) => void;
}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {TOP_PROFESSIONALS.map((pro) => {
            const matchedService = getMatchingServiceForPro(pro);
            return (
              <div
                key={pro.id}
              ...
              >
                <div>
                  ...
                  <div className="space-y-2 mb-4">
                    <span className="text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full bg-brand-50 text-brand-700 block text-center truncate" title={pro.role}>
                      {pro.role}
                    </span>
                ...
                <div className="pt-3 border-t border-slate-100 space-y-3">
                  ...
                  <button
                    onClick={() => onOpenBooking(matchedService, pro)}
