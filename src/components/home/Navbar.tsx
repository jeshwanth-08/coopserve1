            ...
            <div className="flex items-center gap-3 lg:gap-5 flex-1 min-w-0">
              ...
              <nav className="hidden xl:flex items-center gap-1.5 shrink-0 ml-1">
                ...
                <Link
                  ...
                  className="flex items-center gap-1.5 h-9 px-3 rounded-xl text-xs font-bold text-emerald-700 bg-emerald-50/80 hover:bg-emerald-100/80 border border-emerald-200/80 transition-colors shrink-0"
