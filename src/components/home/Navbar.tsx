          ...
          <div className="flex items-center justify-between h-16 gap-3 lg:gap-4">
            ...
            <div className="flex items-center gap-3 lg:gap-5 flex-1 min-w-0">
              ...
              <nav className="hidden lg:flex items-center gap-1 xl:gap-1.5 shrink-0">
                ...
                <Link
                  href="/packages"
                  className="flex items-center gap-1.5 h-9 px-2.5 xl:px-3 rounded-xl text-xs font-semibold text-slate-700 hover:text-brand-600 hover:bg-slate-50 transition-colors shrink-0"
                >
                ...
                <Link
                  href="/ai-diagnosis"
                  className="flex items-center gap-1.5 h-9 px-2.5 xl:px-3 rounded-xl text-xs font-bold text-indigo-700 bg-indigo-50 hover:bg-indigo-100 border border-indigo-200/80 transition-colors shrink-0"
                >
                ...
                <Link
                  ...
                  className="flex items-center gap-1.5 h-9 px-2.5 xl:px-3 rounded-xl text-xs font-bold text-emerald-700 bg-emerald-50 hover:bg-emerald-100 border border-emerald-200/80 transition-colors shrink-0"
                ...
                <Link
                  href="/download/app"
                  className="flex items-center gap-1.5 h-9 px-2.5 xl:px-3 rounded-xl text-xs font-bold text-slate-700 bg-slate-100 hover:bg-slate-200 border border-slate-200 transition-colors shrink-0"
                ...
                <Link
                  href="/membership"
                  className="flex items-center gap-1.5 h-9 px-2.5 xl:px-3 rounded-xl text-xs font-bold text-amber-800 bg-amber-50 hover:bg-amber-100 border border-amber-200/70 transition-colors shrink-0"
                >
              ...
              <div className="hidden xl:flex items-center gap-2 shrink-0">
                ...
                <button
                  ...
                  type="button"
                  className="flex items-center gap-1.5 h-9 px-2.5 rounded-2xl bg-slate-50 hover:bg-slate-100 border border-slate-200/90 text-left transition-all text-xs font-semibold text-slate-700 shrink-0 shadow-sm"
                >
                  ...
                  <div className="leading-tight">
                    <span className="text-slate-800 font-bold flex items-center gap-1 text-xs">
                      <span className="truncate max-w-[95px] inline-block">
                ...
                <button
                  ...
                  type="button"
                  className="flex items-center justify-between h-9 w-36 2xl:w-48 px-2.5 py-1.5 rounded-2xl bg-white hover:bg-slate-50/90 border border-slate-200/90 hover:border-brand-300 text-slate-400 hover:text-slate-600 transition-all text-xs text-left shadow-sm group shrink-0"
                >
                  <div className="flex items-center gap-2 min-w-0 flex-1 mr-1">
                    <Search className="w-3.5 h-3.5 text-brand-600 shrink-0 group-hover:scale-105 transition-transform" />
                    <span className="text-slate-500 truncate whitespace-nowrap text-[11px]">
                      Search services...
                    </span>
                  </div>
                  <kbd className="hidden 2xl:inline-flex items-center px-1.5 py-0.5 text-[9px] font-mono font-medium rounded bg-slate-100 text-slate-500 shrink-0 border border-slate-200/60">
                    ⌘K
                  </kbd>
                </button>
              </div>
