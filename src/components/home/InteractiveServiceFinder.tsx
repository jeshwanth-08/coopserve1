...
export default function InteractiveServiceFinder({
  ...
  const PRIMARY_OPTIONS: PrimaryOption[] = [
    {
      ...
      subQuestions: {
        ...
        choices: [
          {
            label: "AC is blowing warm air or leaking water",
            recommendedServiceId: "serv-1",
            note: "Master Power Jet AC Service & Cooling Diagnosis",
          },
          {
            label: "Water tap is dripping or flush valve running",
            recommendedServiceId: "serv-6",
            note: "Tap Leakage & Flush Tank Overhaul",
          },
          {
            label: "Switchboard sparking or MCB continuously tripping",
            recommendedServiceId: "serv-3",
            note: "Emergency Electrical Health & Wiring Audit",
          },
          {
            label: "Washing machine making loud vibration during spin",
            recommendedServiceId: "serv-11",
            note: "Washing Machine Drum & Motor Repair",
          },
        ],
      },
    },
    {
      ...
      subQuestions: {
        question: "What type of space requires deep sanitization?",
        choices: [
          {
            label: "Bathrooms have stubborn hard water stains",
            recommendedServiceId: "serv-2",
            note: "Intense Bathroom Deep Cleaning & De-scaling",
          },
          {
            label: "Full 2/3 BHK home before/after moving or festival",
            recommendedServiceId: "serv-9",
            note: "Full Home Deep Cleaning (Furnished 2/3 BHK)",
          },
          {
            label: "Sofa and dining chairs have dust or beverage marks",
            recommendedServiceId: "serv-9",
            note: "Sofa Shampooing & Fabric Foam Extraction",
          },
        ],
      },
    },
    {
      ...
      subQuestions: {
        ...
        choices: [
          {
            label: "Hydra facial, skin brightening & crystal pedicure",
            recommendedServiceId: "serv-5",
            note: "Hydra Glow Facial & Diamond Pedicure Combo",
          },
          {
            label: "Relaxing aromatherapy stress relief head & back massage",
            recommendedServiceId: "serv-5",
            note: "At-Home Spa Therapy with Organic Oils",
          },
        ],
      },
    },
    {
      ...
      subQuestions: {
        ...
        choices: [
          {
            label: "Disassemble & reassemble heavy IKEA bed/wardrobes",
            recommendedServiceId: "serv-8",
            note: "Modular Bed & Wardrobe Precision Assembly",
          },
          {
            label: "Pre-move full apartment deep clean and pest gel barrier",
            recommendedServiceId: "serv-9",
            note: "Complete Move-In Sanitization & Safety Pack",
          },
        ],
      },
    },
    {
      ...
      subQuestions: {
        question: "What maintenance upgrade does your home need?",
        choices: [
          {
            label: "Eliminate kitchen cockroaches with safe herbal gel",
            recommendedServiceId: "serv-4",
            note: "Herbal Gel Cockroach & Pest Shield",
          },
          {
            label: "Ceiling fan installation or hanging decorative fixtures",
            recommendedServiceId: "serv-10",
            note: "Ceiling Fan Installation & Regulator Tuning",
          },
          {
            label: "Door lock upgrade or smart digital lock fitting",
            recommendedServiceId: "serv-12",
            note: "Door Lock & Digital Deadbolt Installation",
          },
        ],
      },
    },
  ...
  const recommendedService = selectedSubChoice
    ? POPULAR_SERVICES.find((s) => s.id === selectedSubChoice.recommendedServiceId) ||
      POPULAR_SERVICES[0]
    : null;
