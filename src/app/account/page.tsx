...
export default function CustomerAccountDashboard() {
  ...
  const [addresses, setAddresses] = useState([
    { id: "1", type: "Home", address: "Flat 402, Sunshine Heights, 12th Main Road", locality: "Indiranagar", city: "Bengaluru", isDefault: true },
    { id: "2", type: "Work", address: "Level 4, WeWork Galaxy, 43 Residency Road", locality: "CBD", city: "Bengaluru", isDefault: false },
    { id: "3", type: "Other", address: "House 18, 5th Cross, Palm Meadows", locality: "Whitefield", city: "Bengaluru", isDefault: false },
  ]);

  const [notifications, setNotifications] = useState([
    { id: "n1", title: "Specialist Assigned", desc: "Marcus Thorne (4.9★) is assigned for your AC Jet Service.", time: "10 mins ago", isRead: false },
    { id: "n2", title: "Summer Coupon Active", desc: "Use code COOLSUMMER for 20% off on all appliance repairs.", time: "2 hours ago", isRead: false },
    { id: "n3", title: "Warranty Activated", desc: "30-Day rework warranty active on your Bathroom Deep Clean.", time: "2 days ago", isRead: true },
  ]);
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col selection:bg-brand-500 selection:text-white pb-16 md:pb-0">
      <Navbar
        ...
        onOpenBooking={() => router.push("/book/serv-1")}
      />
            ...
            {activeTab === "overview" && (
              <div className="space-y-6 animate-in fade-in duration-150">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div
                    onClick={() => router.push("/book/serv-1")}
                  ...
                  >
                    ...
                    <p className="text-xs text-slate-500">
                      1-Click rebooking with prefilled address and preferred 4.9★ pro.
                    </p>
                  </div>
            ...
            {(activeTab === "bookings" || activeTab === "upcoming" || activeTab === "past") && (
              <div className="space-y-4 animate-in fade-in duration-150">
                <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                  ...
                  <span className="text-xs font-semibold text-slate-400">Total 3 Bookings</span>
                </div>
              ...
              <div className="space-y-4 animate-in fade-in duration-150">
                <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-xl bg-brand-600 text-white font-bold text-xs flex items-center gap-1"
                  >
                    ...
                    >
                      <div className="flex items-start gap-3.5">
                        ...
                        <div>
                          ...
                          <p className="text-[11px] text-slate-400">{addr.locality}, {addr.city}</p>
                        </div>
                      </div>

                      <div className="flex gap-2">
                        <button className="px-3 py-1.5 text-xs font-bold text-slate-700 hover:bg-slate-100 rounded-lg">
                          Edit
                        </button>
                      </div>
                    </div>
      ...
      <MobileBottomNav onOpenBooking={() => router.push("/book/serv-1")} />
      <Footer />
    </div>
  );
}
