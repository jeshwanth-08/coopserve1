...
export const MOCK_USERS: Record<string, MockUser> = {
  ...
  "sunita.beauty@coop.org": {
    id: "cmtu1vopg00002a1g4urublwb",
    name: "Sunita Sharma",
    email: "sunita.beauty@coop.org",
    role: "PROVIDER",
    locality: "Greenwood Heights",
    phone: "+91 98450 55678",
    address: "23 Lotus Lane, Greenwood Heights",
    password: "password123",
    providerProfile: {
      isVerified: true,
      isActive: true,
      avgRating: 4.8,
      totalReviews: 42,
      skills: ["Bridal Makeup", "Hair Styling", "Facial Treatments", "Mehendi Art"],
      categories: ["Women's Salon & Spa", "Beauty"],
